...
from launch_ros.actions import LoadComposableNodes, SetParameter, SetRemap
...
def generate_launch_description():
    ...
    declare_params_file_cmd = DeclareLaunchArgument(
        'params_file',
        default_value=os.path.join(kobuki_dir, 'config', 'multirobot', 'nav2_params_multirobot.yaml'),
